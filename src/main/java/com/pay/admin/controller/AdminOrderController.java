...
import com.pay.admin.service.AdminOrderService;
...
public class AdminOrderController {
    ...
    @Autowired
    private com.pay.mapper.SystemConfigMapper systemConfigMapper;

    @GetMapping("/timeout")
    public Result<Integer> getTimeout() {
        com.pay.entity.SystemConfig config = systemConfigMapper.selectOne(
                new com.baomidou.mybatisplus.core.conditions.query.LambdaQueryWrapper<com.pay.entity.SystemConfig>()
                        .eq(com.pay.entity.SystemConfig::getConfigKey, "order_timeout_minutes")
        );
        int minutes = 30;
